# Generated by tools/palette.sh from config/waybar/.config/waybar/colors.css; edit tools/palette/btop-theme.tpl instead.
# Tokyo Night (night) for btop, from https://github.com/folke/tokyonight.nvim/tree/main/extras/btop
